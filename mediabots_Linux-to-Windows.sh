...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://software-download.microsoft.com/pr/Win10_21H1_Spanish(Mexico)_x64.iso?t=0f40c51c-399e-467d-a718-fb3462afe274&e=1629902651&h=2f2f173616c8ea6dedb44f802ee68c63 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://software-download.microsoft.com/pr/Win10_21H1_Spanish(Mexico)_x64.iso?t=0f40c51c-399e-467d-a718-fb3462afe274&e=1629902651&h=2f2f173616c8ea6dedb44f802ee68c63
else

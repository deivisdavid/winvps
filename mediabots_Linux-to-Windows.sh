...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/ https://drive.google.com/file/d/1dMIdkvp0f8SqPZ51ezAntPSAHbP9Uz4O/edit
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://drive.google.com/file/d/1dMIdkvp0f8SqPZ51ezAntPSAHbP9Uz4O/edit
else
